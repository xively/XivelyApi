...
```
git clone git://github.com/xively/xively-php.git
```
...
```
git remote add upstream https://github.com/xively/xively-php
git fetch upstream
...
```
git remote add mine git@github.com:<your user name>/xively-php.git
git push mine new_feature_branch
```
Then:
- Navigate to the  repository you just pushed to (e.g. https://github.com/your-user-name/xively-php)
- Click "Pull Request"
